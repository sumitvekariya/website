...
export const site = {
  name: "Sumit Vekariya",
  /**
   * Legacy single-string role (kept for metadata / structured-data continuity).
   * The visible hero tagline is composed from `tagline` below.
   */
  role: "Engineering verifiable systems · moving toward ML evaluation & AI safety",
  /**
   * Structured hero tagline. The two `highlight*` phrases get the marker
   * tint in the page; the connectors are plain prose.
   */
  tagline: {
    lead: "Engineering",
    highlightA: "verifiable systems",
    bridge: "moving toward",
    highlightB: "ML evaluation & AI safety",
  },
  location: "Vadodara, India",
  availability: "Available for ML / AI safety roles",
  email: "sarkazein7@gmail.com",
  handle: "sarkazein",
  handleHref: "https://x.com/sarkazein7",
  /** Hero: one tight paragraph; details below in sections. */
  introLead:
    "Eight years shipping software, five on-chain. 45+ merged PRs across Ethereum.org, OpenZeppelin, Lotus, and Semaphore — production smart contracts, account-abstraction work, and zero-knowledge patterns. Now deepening probabilistic ML and evaluation reliability.",
  /** Short pill chips under the lead — fast keyword hits for a recruiter scan. */
  skillChips: [
    "Solidity 5y",
    "TypeScript 8y",
    "EIP-8004",
  ...
  /** Three hard-edged wins, replaces the redundant 'Key achievements' block. */
  highlights: [
    "Shipped EIP-8004 extensions for autonomous-agent DIDs, live on multiple chains.",
    "Built the ERC-6900 GPG validation module (Alchemy modular-account PR #334).",
    "ETHGlobal New Delhi 2024 — 2nd (Hedera AI), 4th (Polygon Agentic Payments).",
  ],
  /** Inline anchor strip under the hero — visible jump nav, mirrors the ⌘K palette. */
  heroAnchors: [
  ...
  experience: [
    {
      ...
      bullets: [
        "Evaluation research: impact-evaluation design for open-source work — audit-friendly metrics and provenance — presented at Protocol Labs' Impact Evaluators retreat (IERR 2025).",
        "BounTEA: turned GitHub issues into funded on-chain bounties (escrow, lifecycle contracts, and GPG-backed verification).",
  ...
  projects: [
    ...
    },
    {
      ...
      href: "https://github.com/sumitvekariya",
    ...
    },
    {
      ...
      blurb:
        "Peer-to-peer book lending on Solana — borrow flows and ownership records live on-chain; the catalog and Dart client handle the rest.",
    },
  ],
    ...
    books: {
      ...
      items: [
        ...
        },
        {
          ...
          coverSrc:
            "https://covers.openlibrary.org/b/isbn/9781526620172-L.jpg",
        ...
        },
        {
          ...
          author: "Sidney Sheldon",
          note: "Tracy Whitney: betrayal, prison, then revenge as a globe-trotting con artist.",
          coverSrc:
